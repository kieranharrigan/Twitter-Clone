...
//header('Content-Type: application/json');
	...
	$cluster = Cassandra::cluster()->withContactPoints($ips[$ip])->withIOThreads(10)->build();
	$keyspace = 'twitter';
	$session = $cluster->connect($keyspace);

	$cluster1 = Cassandra::cluster()->withContactPoints('192.168.1.10')->withIOThreads(10)->build();
